...
import com.pizenblues.input.Keys.Key;
...
import com.pizenblues.pixeldungeon.effects.ShadowBox;
import com.pizenblues.pixeldungeon.scenes.PixelScene;
import com.pizenblues.utils.Signal;
...
public class Window extends Group implements Signal.Listener<Key> {
	...
	public static final int TITLE_COLOR = 0xf0e276;
