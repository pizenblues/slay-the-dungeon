...
import com.pizenblues.pixeldungeon.items.food.Pasty;
import com.pizenblues.pixeldungeon.items.potions.*;
import com.pizenblues.pixeldungeon.items.rings.*;
import com.pizenblues.pixeldungeon.items.scrolls.*;
import com.pizenblues.pixeldungeon.items.wands.*;
import com.pizenblues.pixeldungeon.items.weapon.*;
import com.pizenblues.pixeldungeon.items.weapon.melee.*;
import com.pizenblues.pixeldungeon.items.weapon.missiles.*;
import com.pizenblues.pixeldungeon.plants.*;
