...
public class PixelDungeon extends Game {
	...
	public PixelDungeon() {
		...
		com.pizenblues.utils.Bundle.addAlias(
			com.pizenblues.pixeldungeon.items.scrolls.ScrollOfUpgrade.class,
			"com.watabou.pixeldungeon.items.scrolls.ScrollOfEnhancement" );
		com.pizenblues.utils.Bundle.addAlias(
			com.pizenblues.pixeldungeon.actors.blobs.WaterOfHealth.class,
			"com.watabou.pixeldungeon.actors.blobs.Light" );
		com.pizenblues.utils.Bundle.addAlias(
			com.pizenblues.pixeldungeon.items.rings.RingOfMending.class,
			"com.watabou.pixeldungeon.items.rings.RingOfRejuvenation" );
		com.pizenblues.utils.Bundle.addAlias(
			com.pizenblues.pixeldungeon.items.wands.WandOfReach.class,
			"com.watabou.pixeldungeon.items.wands.WandOfTelekenesis" );
		com.pizenblues.utils.Bundle.addAlias(
			com.pizenblues.pixeldungeon.actors.blobs.Foliage.class,
			"com.watabou.pixeldungeon.actors.blobs.Blooming" );
		com.pizenblues.utils.Bundle.addAlias(
			com.pizenblues.pixeldungeon.actors.buffs.Shadows.class,
			"com.watabou.pixeldungeon.actors.buffs.Rejuvenation" );
		com.pizenblues.utils.Bundle.addAlias(
			com.pizenblues.pixeldungeon.items.scrolls.ScrollOfPsionicBlast.class,
			"com.watabou.pixeldungeon.items.scrolls.ScrollOfNuclearBlast" );
		com.pizenblues.utils.Bundle.addAlias(
			com.pizenblues.pixeldungeon.actors.hero.Hero.class,
			"com.watabou.pixeldungeon.actors.Hero" );
		com.pizenblues.utils.Bundle.addAlias(
			com.pizenblues.pixeldungeon.actors.mobs.npcs.Shopkeeper.class,
			"com.watabou.pixeldungeon.actors.mobs.Shopkeeper" );
		// 1.6.1
		com.pizenblues.utils.Bundle.addAlias(
			com.pizenblues.pixeldungeon.items.quest.DriedRose.class,
			"com.watabou.pixeldungeon.items.DriedRose" );
		com.pizenblues.utils.Bundle.addAlias(
			com.pizenblues.pixeldungeon.actors.mobs.npcs.MirrorImage.class,
			"com.watabou.pixeldungeon.items.scrolls.ScrollOfMirrorImage$MirrorImage" );
		// 1.6.4
		com.pizenblues.utils.Bundle.addAlias(
			com.pizenblues.pixeldungeon.items.rings.RingOfElements.class,
			"com.watabou.pixeldungeon.items.rings.RingOfCleansing" );
		com.pizenblues.utils.Bundle.addAlias(
			com.pizenblues.pixeldungeon.items.rings.RingOfElements.class,
			"com.watabou.pixeldungeon.items.rings.RingOfResistance" );
		com.pizenblues.utils.Bundle.addAlias(
			com.pizenblues.pixeldungeon.items.weapon.missiles.Boomerang.class,
			"com.watabou.pixeldungeon.items.weapon.missiles.RangersBoomerang" );
		com.pizenblues.utils.Bundle.addAlias(
			com.pizenblues.pixeldungeon.items.rings.RingOfPower.class,
			"com.watabou.pixeldungeon.items.rings.RingOfEnergy" );
		// 1.7.2
		com.pizenblues.utils.Bundle.addAlias(
			com.pizenblues.pixeldungeon.plants.Dreamweed.class,
			"com.watabou.pixeldungeon.plants.Blindweed" );
		com.pizenblues.utils.Bundle.addAlias(
			com.pizenblues.pixeldungeon.plants.Dreamweed.Seed.class,
			"com.watabou.pixeldungeon.plants.Blindweed$Seed" );
		// 1.7.4
		com.pizenblues.utils.Bundle.addAlias(
			com.pizenblues.pixeldungeon.items.weapon.enchantments.Shock.class,
			"com.watabou.pixeldungeon.items.weapon.enchantments.Piercing" );
		com.pizenblues.utils.Bundle.addAlias(
			com.pizenblues.pixeldungeon.items.weapon.enchantments.Shock.class,
			"com.watabou.pixeldungeon.items.weapon.enchantments.Swing" );
		com.pizenblues.utils.Bundle.addAlias(
			com.pizenblues.pixeldungeon.items.scrolls.ScrollOfEnchantment.class,
		...
		// 1.8.0
		com.pizenblues.utils.Bundle.addAlias(
			com.pizenblues.pixeldungeon.actors.mobs.FetidRat.class,
			"com.watabou.pixeldungeon.actors.mobs.npcs.Ghost$FetidRat" );
		com.pizenblues.utils.Bundle.addAlias(
			com.pizenblues.pixeldungeon.plants.Rotberry.class,
			"com.watabou.pixeldungeon.actors.mobs.npcs.Wandmaker$Rotberry" );
		com.pizenblues.utils.Bundle.addAlias(
			com.pizenblues.pixeldungeon.plants.Rotberry.Seed.class,
