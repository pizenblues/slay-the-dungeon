 ...
 */
package com.pizenblues.pixeldungeon;
...
import com.pizenblues.pixeldungeon.actors.mobs.Acidic;
import com.pizenblues.pixeldungeon.actors.mobs.Albino;
import com.pizenblues.pixeldungeon.actors.mobs.Bandit;
import com.pizenblues.pixeldungeon.actors.mobs.Mob;
import com.pizenblues.pixeldungeon.actors.mobs.Senior;
import com.pizenblues.pixeldungeon.actors.mobs.Shielded;
import com.pizenblues.pixeldungeon.items.Item;
import com.pizenblues.pixeldungeon.items.bags.ScrollHolder;
import com.pizenblues.pixeldungeon.items.bags.SeedPouch;
import com.pizenblues.pixeldungeon.items.bags.WandHolster;
import com.pizenblues.pixeldungeon.items.potions.Potion;
import com.pizenblues.pixeldungeon.items.rings.Ring;
import com.pizenblues.pixeldungeon.items.rings.RingOfHaggler;
...
public class Badges {
	...
	public static enum Badge {
		MONSTERS_SLAIN_1( "10 enemies slain", "Bully", 0 ),
		MONSTERS_SLAIN_2( "50 enemies slain","Butcher", 1 ),
		MONSTERS_SLAIN_3( "150 enemies slain","Slayer", 2 ),
		MONSTERS_SLAIN_4( "250 enemies slain","Serial clicker", 3 ),
		GOLD_COLLECTED_1( "100 gold collected","Junkyard king", 4 ),
		GOLD_COLLECTED_2( "500 gold collected","Mr moneymaker", 5 ),
		GOLD_COLLECTED_3( "2500 gold collected","Richie Rich", 6 ),
		GOLD_COLLECTED_4( "7500 gold collected","Bazillionaire", 7 ),
		...
		ALL_POTIONS_IDENTIFIED( "All potions identified","Doctor", 16 ),
		ALL_SCROLLS_IDENTIFIED( "All scrolls identified","Librarian", 17 ),
		ALL_RINGS_IDENTIFIED( "All rings identified","Bling bling", 18 ),
		ALL_WANDS_IDENTIFIED( "All wands identified",":^)", 19 ),
		ALL_ITEMS_IDENTIFIED( "All potions, scrolls, rings & wands identified","Encyclopedia", 35, true ),
		...
		BOSS_SLAIN_1( "1st boss slain","(baby) Dragon slayer", 12 ),
		BOSS_SLAIN_2( "2nd boss slain","Ghoul Exorciser", 13 ),
		BOSS_SLAIN_3( "3rd boss slain","Griffin Crusher", 14 ),
		BOSS_SLAIN_4( "4th boss slain","Dungeon Master", 15 ),
		...
		BOSS_SLAIN_3_ALL_SUBCLASSES( 
			"3rd boss slain by Knight, Berserker, Warlock, Deathpriest, Shadow master, Assassin, Barbarian & Warden","", 33, true ),
		RING_OF_HAGGLER( "Ring of Haggler obtained","", 20 ),
		RING_OF_THORNS( "Ring of Thorns obtained","", 21 ),
		STRENGTH_ATTAINED_1( "13 points of Strength attained","Lil Muscles", 40 ),
		STRENGTH_ATTAINED_2( "15 points of Strength attained","Brute", 41 ),
		STRENGTH_ATTAINED_3( "17 points of Strength attained","Strong boy", 42 ),
		STRENGTH_ATTAINED_4( "19 points of Strength attained","Iron fist", 43 ),
		...
		RARE_SENIOR,
		RARE_ACIDIC,
		RARE( "All rare monsters slain","Endangered species", 37, true ),
		VICTORY_WARRIOR,
		VICTORY_MAGE,
		VICTORY_ROGUE,
		VICTORY_HUNTRESS,
		VICTORY( "The king's cranium obtained","", 22 ),
		VICTORY_ALL_CLASSES( "The king's cranium obtained by Warrior, Mage, Rogue & Huntress","Ok, you won!", 36, true ),
		MASTERY_COMBO( "7-hit combo","", 56 ),
		POTIONS_COOKED_1( "3 potions cooked","You can fry an egg", 52 ),
		POTIONS_COOKED_2( "6 potions cooked","2 michelin stars", 53 ),
		POTIONS_COOKED_3( "9 potions cooked","Maestro parrillero", 54 ),
		POTIONS_COOKED_4( "12 potions cooked","Master chef", 55 ),
		NO_MONSTERS_SLAIN( "Level completed without killing any monsters", "Pacifist",28 ),
		GRIM_WEAPON( "Monster killed by a Grim weapon","", 29 ),
		PIRANHAS( "6 piranhas killed", "go fishing",30 ),
		NIGHT_HUNTER( "15 monsters killed at nighttime", "Insomniac",58 ),
		...
		HAPPY_END( "Go look at the sky","Happy end", 38 ),
		...
		private Badge( String description, String title, int image ) {
			this( description, title, image, false );
		}
		
		private Badge( String description, String title, int image, boolean meta ) {
